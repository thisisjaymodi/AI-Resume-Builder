...
export const dummyResumeData = [
  ...
  },
  {
    ...
    project: [
      {
        name: "Invoice - Invoice Management System",
        type: "Web Application (FinTech)",
        description:
          "Invoice is a secure web platform that allows freelancers and small businesses to generate, track, and automate professional invoices. Built with Node.js, MongoDB, and Stripe integration.",
