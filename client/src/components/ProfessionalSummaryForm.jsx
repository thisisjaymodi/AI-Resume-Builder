    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button disabled={isGenerating} onClick={generateSummary} className="flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50">
          ...
          {isGenerating ?  "Generating Content..." : "Rewrite using AI" }
        </button>
      </div>
      ...
      <div className="mt-6">
        <textarea
          ...
          className="w-full p-3 px-4 mt-2 border text-sm border-grey-300 rounded-lg focus:ring focus:ring-blue=500 focus:border-blue-500 outline-none transition-colors resize-none"
          name=""
          id=""
