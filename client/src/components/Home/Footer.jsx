...
const Footer = () => {
  return (
    <>
      ...
      <footer
        id="cta"
        className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-black-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40"
      >
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          <p className="max-w-60">made with ❤️ in 🍁 </p>
          ...
          <p className="mt-3 text-center">
            ...
            <a
              href="http://www.linkedin.com/in/thisisjaymodi"
              target="_blank"
