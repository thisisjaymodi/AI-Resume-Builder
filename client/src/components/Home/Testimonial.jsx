...
const Testimonial = () => {
  ...
  const CreateCard = ({ card }) => (
    <div
      id="testimonials"
      className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0"
    >
    ...
    <>
      ...
      >
        ...
        <Title
          ...
          description="Hear what our
                users say about us. We're always looking for ways to improve.
                If you
