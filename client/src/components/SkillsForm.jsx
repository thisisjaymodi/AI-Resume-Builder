    ...
    <div className="space-y-4">
           ...
           return (<span
            ...
            >
              ...
              <button
                ...
                className="m1-1 hover:bg-green-200 rounded-full p-0.5 transition-colors"
              >
                <X className="w-3 h-3" />
              </button>
            </span>);
      ...
      <div className="bg-green-50 p-3 rounded-lg">
        <p className="text-sm text-green-800">
          ...
          skills (programming language tools) and soft skills (leadership,
          communication).
        </p>
      </div>
    </div>
